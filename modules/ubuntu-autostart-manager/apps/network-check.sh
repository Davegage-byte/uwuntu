...
class NetworkCheckApp(Gtk.Application):
    ...
    def do_activate(self):
        ...
        self.window.set_title("Network Check v2.44 + Wipe Auto v3.33 + Audio EXP")
        ...
        title_label = Gtk.Label(label="Network Check v2.44 + Wipe Auto v3.33 + Audio EXP")
    ...
    def install_css(self):
        ...
        /* Fokus bleibt klar blau sichtbar, darf aber keinen Platz
           außerhalb des Buttons beanspruchen und damit das Fenster verbreitern. */
