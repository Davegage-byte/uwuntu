...
class ConnectionCard:
    def __init__(self, title):
        ...
        self.state_label.set_width_chars(16)
        self.state_label.set_max_width_chars(16)
...
class NetworkCheckApp(Gtk.Application):
    ...
    def do_activate(self):
        ...
        self.window.set_title("Network Check v2.41 + Wipe Auto v3.33 + Audio EXP")
        ...
        title_label = Gtk.Label(label="Network Check v2.41 + Wipe Auto v3.33 + Audio EXP")
